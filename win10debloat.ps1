...
$Panel1.controls.AddRange(@($librewolf,$firefox,$7zip,$sharex,$foxit,$notepad,$gchrome,$mpc,$vlc,$powertoys,$winterminal,$Label2,$everythingsearch,$sumatrapdf,$imageglass,$gimp,$Label7,$Label8,$Label9,$advancedipscanner,$putty,$etcher,$translucenttb,$githubdesktop,$discord,$autohotkey))
