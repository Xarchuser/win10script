...
$foxit 			         = New-Object system.Windows.Forms.Button
...
$Panel1.controls.AddRange(@($librewolf,$firefox,$7zip,$sharex,$foxit,$notepad,$gchrome,$mpc,$vlc,$vscode,$vscodium,$powertoys,$winterminal,$Label2,$everythingsearch,$sumatrapdf,$imageglass,$gimp,$Label7,$Label8,$Label9,$advancedipscanner,$putty,$etcher,$translucenttb,$githubdesktop,$discord,$autohotkey))
...
$foxit.Add_Click({
    ...
    $ResultText.text = "`r`n" +"`r`n" + "Installing Foxit Reader... Please Wait" 
    winget install -e Foxit.FoxitReader| Out-Host
    if($?) { Write-Host "Installed Foxit Reader" }
    $ResultText.text = "`r`n" + "Finished Installing Foxit Reader" + "`r`n" + "`r`n" + "Ready for Next Task"
})
